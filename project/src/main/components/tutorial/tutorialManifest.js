...
export const tutorialManifest = [
  createQueryEntry({
    ...
    groupKey: 'account',
    order: 0,
    path: buildLocalePath('zh-Hant', '/auth'),
  ...
  createPathEntry({
    ...
    groupKey: 'account',
    order: 5,
    path: buildLocalePath('zh-Hant', '/auth/data'),
  }),
  createPathEntry({
    key: 'auth-regions',
    groupKey: 'account',
    order: 6,
    path: buildLocalePath('zh-Hant', '/auth/regions'),
  }),
  createPathEntry({
    key: 'menu-query-char',
    groupKey: 'menuQuery',
    order: 7,
    path: buildLocalePath('zh-Hant', '/menu/query/char'),
  }),
  createPathEntry({
  ...
  createPathEntry({
    ...
    groupKey: 'menuQuery',
    order: 9,
    path: buildLocalePath('zh-Hant', '/menu/query/yinwei'),
  }),
  createPathEntry({
    key: 'menu-query-tone',
    groupKey: 'menuQuery',
    order: 10,
    path: buildLocalePath('zh-Hant', '/menu/query/tone'),
  }),
  createPathEntry({
    key: 'menu-compare-char',
    groupKey: 'menuCompare',
    order: 11,
    path: buildLocalePath('zh-Hant', '/menu/compare/char'),
  }),
  createPathEntry({
  ...
  createPathEntry({
    ...
    groupKey: 'menuCompare',
    order: 13,
    path: buildLocalePath('zh-Hant', '/menu/compare/tone'),
  }),
  createPathEntry({
    key: 'menu-map-view',
    groupKey: 'menuMap',
  ...
  createPathEntry({
    ...
    groupKey: 'menuMap',
    order: 15,
    path: buildLocalePath('zh-Hant', '/menu/map/divide'),
  }),
  createPathEntry({
    key: 'menu-map-custom',
    groupKey: 'menuMap',
    order: 16,
    path: buildLocalePath('zh-Hant', '/menu/map/custom'),
  }),
  createPathEntry({
    key: 'menu-pho-matrix',
  ...
  createPathEntry({
    ...
    groupKey: 'menuPhonology',
    order: 18,
    path: buildLocalePath('zh-Hant', '/menu/pho/custom'),
  }),
  createPathEntry({
    key: 'menu-pho-count',
    groupKey: 'menuPhonology',
    order: 19,
    path: buildLocalePath('zh-Hant', '/menu/pho/count'),
  }),
  createPathEntry({
    key: 'menu-pho-evolution',
    groupKey: 'menuPhonology',
    order: 20,
    path: buildLocalePath('zh-Hant', '/menu/pho/evolution'),
  }),
  createPathEntry({
    key: 'menu-result',
    groupKey: 'menuResources',
    order: 21,
    path: buildLocalePath('zh-Hant', '/menu/result'),
  }),
  createPathEntry({
  ...
  createPathEntry({
    ...
    groupKey: 'menuResources',
    order: 23,
    path: buildLocalePath('zh-Hant', '/menu/about/suggestion'),
  }),
  createPathEntry({
    key: 'menu-about-like',
    groupKey: 'menuResources',
    order: 24,
    path: buildLocalePath('zh-Hant', '/menu/about/like'),
  }),
  createPathEntry({
  ...
  createPathEntry({
    ...
    groupKey: 'menuResources',
    order: 27,
    path: buildLocalePath('zh-Hant', '/menu/privacy'),
  }),
  createPathEntry({
    key: 'menu-tools',
    groupKey: 'menuResources',
  ...
  createPathEntry({
    ...
    order: 32,
    path: buildLocalePath('zh-Hant', '/explore/tools/check'),
  }),
  createPathEntry({
    key: 'explore-jyut2ipa',
    groupKey: 'exploreTools',
    order: 33,
    path: buildLocalePath('zh-Hant', '/explore/tools/jyut2ipa'),
  }),
  createPathEntry({
    key: 'explore-merge',
    groupKey: 'exploreTools',
    order: 34,
    path: buildLocalePath('zh-Hant', '/explore/tools/merge'),
  }),
  createPathEntry({
    key: 'explore-manage',
    groupKey: 'exploreTools',
    order: 35,
    path: buildLocalePath('zh-Hant', '/explore/manage'),
  }),
  createQueryEntry({
  ...
  createQueryEntry({
    ...
    order: 40,
    path: buildLocalePath('zh-Hant', '/explore/yubao'),
  ...
  createQueryEntry({
    ...
    groupKey: 'exploreResources',
    order: 42,
    path: buildLocalePath('zh-Hant', '/explore/char-class'),
  ...
  createPathEntry({
    ...
    groupKey: 'exploreResources',
    order: 46,
    path: buildLocalePath('zh-Hant', '/explore/yc-spoken'),
  }),
  createPathEntry({
    key: 'explore-villages-gd',
    groupKey: 'exploreVillages',
    order: 47,
    path: buildLocalePath('zh-Hant', '/explore/villages/gd'),
  }),
  createPathEntry({
    key: 'explore-villages-table',
    groupKey: 'exploreVillages',
    order: 48,
    path: buildLocalePath('zh-Hant', '/explore/villages/table'),
  }),
  createPathEntry({
    key: 'explore-villages-yc',
    groupKey: 'exploreVillages',
    order: 49,
    path: buildLocalePath('zh-Hant', '/explore/villages/yc'),
  }),
]
