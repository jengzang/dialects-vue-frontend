...
![文白读顏色標注：紅文读、藍白读](/tutorial/menu-query-zhonggu/04-wenbai.webp)
...
![右下角切換显示模式：全显 vs 主体](/tutorial/menu-query-zhonggu/05-display-mode.webp)
...
![地图頁面——方言數據空間分布](/tutorial/menu-query-zhonggu/03-map.webp)

## 提示

- 首次使用建议只选 1-2 个核心条件，结果更容易看懂
- 结果太多时先加分區缩小范围；结果太少时减少条件数量
- 按鈕灰色时通常表示中古条件尚未形成有效查询
