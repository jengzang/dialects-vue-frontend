...
describe('color theme token coverage', () => {
  ...
  it('uses neutral primary accents for light and white primary accents for dark themes', () => {
    ...
    expect(lightBlock).toContain('--color-primary: #5f6368;')
    expect(lightBlock).toContain('--color-primary-rgb: 95, 99, 104;')
    expect(lightBlock).toContain('--color-primary-cyan: #8e9196;')
  ...
  it('maps VillagesML blue tokens to non-blue theme accents', () => {
    ...
    expect(lightBlock).toContain('--vml-blue: #5f6368;')
    expect(lightBlock).toContain('--vml-blue-rgb: 95, 99, 104;')
    expect(lightBlock).toContain('--vml-blue-highlight: #8e9196;')
