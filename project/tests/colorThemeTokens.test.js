...
describe('color theme token coverage', () => {
  ...
  it('keeps the light theme off-white instead of yellow', () => {
    ...
    expect(lightBlock).toContain('--bg-blue-light: #fbfcfe;')
    expect(lightBlock).toContain('--surface-panel: rgba(255, 255, 255, 0.84);')
    expect(lightBlock).toContain('--surface-selected: #f7f9fc;')
    expect(lightBlock).not.toContain('#f8fafc')
  ...
  it('maps VillagesML blue tokens to non-blue theme accents', () => {
    ...
    expect(lightBlock).toContain('--vml-blue-highlight: #6e7681;')
