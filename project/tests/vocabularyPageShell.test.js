...
describe('vocabulary explore page shell wiring', () => {
  ...
  it('feeds VocabularyMap drawable aggregate points and a fixed-height canvas', () => {
    ...
    expect(vocabularyMap).toContain("const displayMode = ref('overview')")
    expect(vocabularyMap).not.toContain("const displayMode = ref('pronunciation')")
    ...
    expect(vocabularyMap).toContain('text = item.entryCount ? String(item.entryCount) : item.note1')
