...
describe('vocabulary permission cache', () => {
  ...
  it('keeps the refresh permission action near the edit permission request action', () => {
    ...
    expect(vocabularyImportPage.indexOf("t('words.wordList.access.refreshPermission')"))
      .toBeLessThan(vocabularyImportPage.indexOf("t('words.wordList.access.requestEditPermission')"))
