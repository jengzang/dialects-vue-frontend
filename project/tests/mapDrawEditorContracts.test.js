...
describe('Map draw editor contracts', () => {
  ...
  it('wires map draw history to commands and keyboard shortcuts', () => {
    ...
    expect(tabSource).toContain('const canAttemptVertexDelete = currentMode.value')
    expect(tabSource).toContain('isDelete && (canDeleteSelection.value || canAttemptVertexDelete)')
