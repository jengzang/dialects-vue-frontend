...
describe('Map draw editor contracts', () => {
  ...
  it('prevents drawing and destructive actions while the active layer is hidden or locked', () => {
    ...
    expect(featuresSource).toMatch(/async function handleDeleteSelected\(\) \{[\s\S]*if \(!canDeleteSelection\.value\) \{[\s\S]*reportGeometryEditFeedback\('error', 'vertexDeleteFailed'\)/)
