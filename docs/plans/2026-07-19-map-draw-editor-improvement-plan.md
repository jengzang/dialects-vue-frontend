...
| Step 7 图层管理易用性 | 部分完成 | `a3b10d90`、`9e0f5a92`、`43d828a4`、`91c5321f`、`7744c532`、`0e44785b` | 已支持复制图层、复制选中要素、删除图层确认、图层行显示几何/要素数/显示锁定状态，并阻止隐藏或锁定活动图层继续绘制/删除/清空。 |
...
1. 完成 Step 7 剩余项：图层重命名入口前置、多选/批量操作的范围确认。
